...
> **Video update (22 September 2026):** the public customer path now accepts
> bounded video input by converting each clip to at most eight timestamped,
> 768px frames in the gateway. Direct vLLM `:8001` remains image-only. See
> `docs/VIDEO-SUPPORT-2026-09-22.md` for limits and live verification.
