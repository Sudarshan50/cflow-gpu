...
# A reclaimed droplet comes back on a different IP, so this cannot be a constant.
...
stage_secrets() {
  ...
  # Defaulted, not required from the environment: plain sudo drops SECRETS_BUNDLE.
